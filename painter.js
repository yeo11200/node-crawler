  ...
  return {
    ...
    toCommand: function () {
      ...
      if (pos.del == 1) {
        ...
        // 오류 가능성 농후
		ctx.clearRect(X1.X-(lineWidth/2) , X1.Y-(lineWidth/2), lineWidth, lineWidth);
    }
...
function onLoadPage() {
  ...
  canvas.addEventListener("touchmove", mouseListener);
  canvas.addEventListener("touchend", mouseListener);
  canvas.addEventListener("touchcancel", mouseListener);
